...
public class InfoUniServiceController {
	...
	public String getInfoUni(@PathVariable String university) {
		String infoUni =  
			university + " è stata fondata nel " + infoServiceImpl.getUniversityInfoByUniversityService() +
			" e ha "+ infoServiceImpl.getUniversityInfoByFacultyService() + " facoltà.";
	...
	public String getInfoUni(@PathVariable String university,@PathVariable String faculty) {
		String infoUni =  
			university + " è stata fondata nel " + infoServiceImpl.getUniversityInfoByUniversityService() + " e " + 
			faculty + " ha un piano di studi di " + infoServiceImpl.getFacultyInfoByFacultyService() + 
			" esami per un totale di " + infoServiceImpl.getFacultyInfoByCourseService() + " crediti.";
		logger.info("getInfoUni(): " + infoUni);
		return infoUni; 
	}
	...
	public String getInfoUni(@PathVariable String university,@PathVariable String faculty,@PathVariable String course) {
		String infoUni =  
			university + " è stata fondata nel " + infoServiceImpl.getUniversityInfoByUniversityService() + ", " + 
			faculty + " ha un piano di studi di " + infoServiceImpl.getFacultyInfoByFacultyService() + " esami con " + 
			course + " avente " + infoServiceImpl.getCourseInfoByCourseService() + " crediti.";
		logger.info("getInfoUni(): " + infoUni);
		return infoUni; 
	}
